...
const TaskType = new GraphQLObjectType({
    ...
    fields: () => ({
        ...
        project: {
            type: TaskType,
            resolve(parent, args) {
                const project = _.find(projects, {id: parent.projectId});
...
const ProjectType = new GraphQLObjectType({
    ...
    fields: {
        ...
        tasks: {
            ...
            resolve(parent, args) {
                const result = _.filter(tasks, {projectId: parent.id})
                return result;
            }
        }
    }
...
const RootQuery = new GraphQLObjectType({
    ...
    fields: {
        task: {
            ...
            resolve(parent, args) {
                const result = _.find(tasks, {id: args.id});
                const testResult = _.find(projects, {id: result.projectId})
                console.log(result.projectId);
                console.log("Project: "+testResult);
                return result;
            }
        },
        tasks: {
        ...
        project: {
            ...
            args: {id: {type: GraphQLID}},
            resolve(parent, args) {
                const result = _.find(projects, {id: args.id});
                return result;
            }
        },
        projects: {
