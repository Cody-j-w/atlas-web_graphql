...
const TaskType = new GraphQLObjectType({
    ...
    fields: () => ({
        ...
        project: {
            type: TaskType,
            resolve(parent, args) {
                const project = Project.findById(parent.projectId);
                return project;
            }
        }
    })
...
const ProjectType = new GraphQLObjectType({
    ...
    fields: {
        ...
        tasks: {
            ...
            resolve(parent, args) {
                const tasks = Task.find({projectId: parent.id});
                return tasks;
            }
        }
    }
...
const RootQuery = new GraphQLObjectType({
    ...
    fields: {
        task: {
            ...
            resolve(parent, args) {
                const result = Task.findById(args.id);
                return result;
            }
        },
        tasks: {
        ...
        project: {
            ...
            args: {id: {type: GraphQLID}},
            resolve(parent, args) {
                const result = Project.findById(args.id);
                return result;
            }
        },
        projects: {
